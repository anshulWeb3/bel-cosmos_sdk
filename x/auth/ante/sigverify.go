...
func (spkd SetPubKeyDecorator) AnteHandle(ctx sdk.Context, tx sdk.Tx, simulate bool, next sdk.AnteHandler) (sdk.Context, error) {
	...
	fmt.Println("========================SetPubKeyDecorator=================")
	...
	for i, pk := range pubkeys {
		...
		addr, _ := hex.DecodeString(pk.Address().String())

		addr2 := sdk.AccAddress(addr)

		fmt.Println(pk.Address(), "==============================PK.ADDRESS===============================================")
		...
		fmt.Println(acc.GetPubKey(), "==============================acc.GetPubKey()===============================================")
		fmt.Println(acc.GetAddress(), "==============================acc.GetAddress()===============================================")
...
func (sgcd SigGasConsumeDecorator) AnteHandle(ctx sdk.Context, tx sdk.Tx, simulate bool, next sdk.AnteHandler) (newCtx sdk.Context, err error) {
	...
	fmt.Println("========================SigGasConsumeDecorator=================")
...
func (svd SigVerificationDecorator) AnteHandle(ctx sdk.Context, tx sdk.Tx, simulate bool, next sdk.AnteHandler) (newCtx sdk.Context, err error) {
	...
	fmt.Println("========================SigVerificationDecorator=================")
...
func (isd IncrementSequenceDecorator) AnteHandle(ctx sdk.Context, tx sdk.Tx, simulate bool, next sdk.AnteHandler) (sdk.Context, error) {
	...
	fmt.Println("========================IncrementSequenceDecorator=================")
...
func (vscd ValidateSigCountDecorator) AnteHandle(ctx sdk.Context, tx sdk.Tx, simulate bool, next sdk.AnteHandler) (sdk.Context, error) {
	...
	fmt.Println("========================ValidateSigCountDecorator=================")
